...
//
// お問い合わせはサイト内のフォーム（api/contact.js）で完結する。
// CONTACT_FORM_URL は外部フォームを併設したい場合だけ埋めればよい（空で問題ない）。
// ============================================================================
...
/**
 * 外部のお問い合わせフォーム（Google フォームなど）の URL。**任意**。
 * サイト内のフォーム（/api/contact）が主で、これは補助的な追加窓口。
 * 空でも /contact は完全に機能する。
 */
 ...
 * ズレを検出する。
 */
export const NEWS_FEED_COUNT = 31;
