...
import { SITE_NAME, SITE_URL, SCORE_FORMULA, VERDICTS, SOURCES, NEWS_FEED_COUNT } from '../config/site.js';
      ...
      <div className="prose">
        ...
        <ul>
          <li>
            ...
            Wikipedia は日本語版、ニュースは国内 {NEWS_FEED_COUNT} 媒体、App Store は日本ストアです。
            海外で先に起きている動きは拾えません。
          </li>
          <li>
